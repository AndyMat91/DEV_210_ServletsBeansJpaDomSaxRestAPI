...
import com.example.dev_200_1_network_client_data_storage_system_jpa.beans.XML.DemoSAX;
...
public class CheckSAX extends HttpServlet {
    ...
    private void getPage(PrintWriter out) {
        ...
        out.println("<h1 style=\"text-align: center\">Таблица на основе файла Clients.xml (SAX парсер)</h1>");
        ...
        out.println("</tr>\n");
        AppStore.clients.forEach(client -> {
            out.println("<tr>\n");
        ...
        out.println("<form action=\"CheckSAX\" method=\"post\">");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (savedSessionId.equals(currentSessionId)) {
            ...
            try {
                demoSAX = new DemoSAX();
                demoSAX.setParam("all");
                parser.parse(newFile, demoSAX);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (savedSessionId.equals(currentSessionId)) {
            ...
            if (request.getParameter("name").equals("Search")) {
                ...
                try {
                    demoSAX = new DemoSAX();
                    demoSAX.setParam(Objects.toString(request.getParameter("client-name"), "").trim());
                    parser.parse(newFile, demoSAX);
                } catch (SAXException e) {
                    throw new RuntimeException(e);
                }
